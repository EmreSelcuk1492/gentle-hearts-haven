          ...
          <div className="relative container mx-auto px-4 md:px-6 max-w-7xl">
            ...
            <div className="text-center max-w-5xl mx-auto">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight mb-6">
                Energy Medicine
                <br />
                <span className="text-4xl md:text-6xl">Specialist</span>
              </h1>
              
              <p className="text-xl text-gray-700 mb-8 leading-relaxed max-w-4xl mx-auto">
                Certified by the <strong className="text-gray-900">World Institute For Incurable Diseases™</strong> in the transformative <strong style={{color: '#8E4EC6'}}>Be Well Science™</strong> method, pioneered by Master Del Pe
              </p>
